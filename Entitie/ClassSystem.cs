namespace RPG_system.Entitie
{
	 ...
	 */
	internal static class ClassSystem
	{
		/* 
		 * Correct order: 
		...
		*/
		...
		public static decimal[] ChoiseYourClass(byte choose)
		{
			...
			{
				default:// Warrior
					return [/*Level*/1.0M,/*Weight*/1.0M,/*Life*/1.3M,/*Histamine*/1.3M,/*Mana*/0.9M,/*Inventor*/1.0M,
				...
				case 1: // Wizard
					return [/*Level*/1.0M,/*Weight*/1.0M,/*Life*/1.0M,/*Histamine*/0.9M,/*Mana*/1.3M,/*Inventor*/1.3M,
				...
				case 2:// Assassin
					return [/*Level*/1.0M,/*Weight*/1.0M,/*Life*/0.8M,/*Histamine*/1.1M,/*Mana*/1.1M,/*Inventor*/1.1M,
