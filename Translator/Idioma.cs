namespace RPG_system.Translator
{
	internal class Idioma
	{
		...
		public static string ChoiseYourLanguage = "Choise your language:";
		public static string[] ChoiseIndioma = ["English", "Portuguese"];

		// Here is Menu
		public static string NameHomeMenu = "RPG System in C#";
		public static string[] Menus = ["Play", "Language", "Exit"];
		...
		public static string[] _indChoiseRace = ["Human", "Ogro"];
